...
<tr>
 ...
 <input type="hidden" id="hdnQuestArray" value=${strQuestArray}/>
...
<div class="quiz-over">
 ...
 var inputText = document.getElementById('hdnQuestArray').value;
...
var arr=[];
 ...
 function load(){
  ...
  // question.innerHTML=arr[1];

  question.innerHTML=arr[questionIndex];
