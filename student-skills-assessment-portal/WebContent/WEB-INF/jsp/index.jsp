...
<body>
    ...
    <div class="header-wrapper">
      <div class="logo-wrap">
        <a href="#" class="hover-target"><span>PLACEMENT </span>TEST</a>
      </div>
  ...
  <div class="nav">
    <div class="nav__content">
      <ul class="nav__list">
        <li class="nav__list-item active-nav"><a href="#" class="hover-target">ome</a></li>
...
<!--------------- prograss bar for use the back to home starts here--------------->
...
<!--------------- prograss bar for use the back to home ends here --------------->
...
<table style="width:100%">
  <tr>
    <th><div class="new" id="show"><div class="hover-target">Aptitude</div></div></th>
    <th><div class="new"><div class="hover-target">Verbale</div></div></th>
    <th><div class="new"><div class="hover-target">Logical</div></div></th>
    <th><div class="new"><div class="hover-target">GK</div></div></th>
  </tr>
  <tr>
    <td><div class="new" id="show"><div class="hover-target">Programming</div></div></td>
    <td><div class="new" id="show"><div class="hover-target">Puzzles</div></div></td>
    <td><div class="new" id="show"><div class="hover-target">Technical</div></div></td>
    <td><div class="new" id="show"><div class="hover-target">Aptitude</div></div></td>
  </tr>
</table>
...
<div class="hidden" style="display: none;">
                  <div class="heading">
                    <h1>Aptitude Test</h1>
                    <br>
                    <p>Aptitude Test: Free Online Aptitude Questions and answers for exam preparation. We cover all sections under quantitative aptitude and data interpretation. Aptitude Test Questions is one of the most important sections in the entire competitive, Campus and entrance online test. Evaluate your Aptitude test questions skills by trying the online exams and know your score.</p>

                  </div>
                  
                  <h2>Aptitude Tests. Free Practice Aptitude Test</h2>
        ...
        <div class="grid grid--effect-canopus">
          <a href="#" class="grid__item grid__item--c1">
            <div class="stack">
              ...
              <div class="stack__figure">
                <img class="stack__img" src="https://images.pexels.com/photos/853199/pexels-photo-853199.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="Image"/>
              </div>
            </div>
          ...
          <a href="#" class="grid__item grid__item--c2">
            <div class="stack">
              ...
              <div class="stack__deco"></div>
              <div class="stack__figure">
                <img class="stack__img" src="https://images.pexels.com/photos/807598/pexels-photo-807598.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="Image"/>
              </div>
            </div>
            <div class="grid__item-caption">
          ...
          <a href="#" class="grid__item grid__item--c3">
            <div class="stack">
              ...
              <div class="stack__deco"></div>
              <div class="stack__figure">
                <img class="stack__img" src="img3.jpg" alt="Image"/>
              </div>
            </div>
            <div class="grid__item-caption">
          ...
          <a href="#" class="grid__item grid__item--c1">
            <div class="stack">
              ...
              <div class="stack__deco"></div>
              <div class="stack__figure">
                <img class="stack__img" src="img1.jpg" alt="Image"/>
              </div>
            </div>
            <div class="grid__item-caption">
              <h3 class="grid__item-title">anaerobic</h3>
          ...
          <a href="#" class="grid__item grid__item--c2">
            <div class="stack">
              ...
              <div class="stack__deco"></div>
              <div class="stack__figure">
                <img class="stack__img" src="img2.jpg" alt="Image"/>
              </div>
            </div>
            <div class="grid__item-caption">
              <h3 class="grid__item-title">exothermic</h3>
                        ...
                        <div class="info">
                              <div class="row">
                                    <div class="col-lg-4" id="personal">
                                          ...
                                          <h4 class="wow fadeInUp" data-wow-delay="0.2s">parthi</h4>
                                          <br><br>
                                    </div>
                                    ...
                                    <div class="col-lg-4" id="address">
                                          ...
                                          <h4 class="wow fadeInUp" data-wow-delay="0.2s">parthi@gmail.com</h4>
                                          <br><br>
                                    </div>
                              </div>
                        </div>
...
new WOW().init(); // for more importain in this project..
...
<!-- Title to select the test script for hide and show --> 
<script type="text/javascript">
...
<!-- progress -wrap used for the back to top(HOME) script -->
